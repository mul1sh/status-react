...
(def icons
  (if platform/desktop?
    ...
    {:icons/discover            (components.svg/slurp-svg "./resources/icons/bottom/discover_gray.svg")
     ...
     :icons/share-profile       (components.svg/slurp-svg "./resources/icons/share_profile.svg")
     :icons/tribute-to-talk     (components.svg/slurp-svg "./resources/icons/ttt.svg")
     :icons/remove              (components.svg/slurp-svg "./resources/icons/remove.svg")
