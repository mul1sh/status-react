...
(def icons
  (if platform/desktop?
    ...
    {:icons/discover            (components.svg/slurp-svg "./resources/icons/bottom/discover_gray.svg")
     ...
     :icons/change              (components.svg/slurp-svg "./resources/icons/change.svg")
     :icons/copy-from           (components.svg/slurp-svg "./resources/icons/copy_from.svg")
     :icons/paste               (components.svg/slurp-svg "./resources/icons/paste.svg")
     ...
     :icons/sliders             (components.svg/slurp-svg "./resources/icons/sliders.svg")
